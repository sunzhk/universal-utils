...
//	private SoftArrayList<Fragment> mFragments;
	
	private SparseArray<SoftArrayList<Fragment>> mFragmentsMap = new SparseArray<SoftArrayList<Fragment>>();
//	private HashMap<Integer, SoftArrayList<Fragment>> mFragmentsMap;
	
//	private Fragment currentFragment;
	
	private SparseArray<SoftReference<Fragment>> currentFragmentsMap = new SparseArray<SoftReference<Fragment>>();
//	private HashMap<Integer, SoftReference<Fragment>> currentFragmentsMap = new HashMap<Integer, SoftReference<Fragment>>();
...
//		mFragments = new SoftArrayList<Fragment>();
//		mFragmentsMap = new HashMap<Integer, SoftArrayList<Fragment>>();
